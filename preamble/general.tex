...
\usepackage{listings}
\usepackage{textcomp} % Often recommended with listings for specific characters
% Define Python style for listings
\definecolor{codegreen}{rgb}{0,0.6,0}
\definecolor{codegray}{rgb}{0.5,0.5,0.5}
\definecolor{codepurple}{rgb}{0.58,0,0.82}
\definecolor{backcolour}{rgb}{1.0,1.0,0.85} % Light yellow background

\lstdefinestyle{mystyle}{
    backgroundcolor=\color{backcolour},
    commentstyle=\color{codegreen},
    keywordstyle=\color{blue}, % Using blue for keywords as green is for comments
    ...
    captionpos=b,
    keepspaces=true,
    numbers=none, % Or 'left' if you want line numbers
    numbersep=5pt,
    showspaces=false,
    ...
    tabsize=2,
    language=Python,
    morekeywords={*,...} % Add keywords if needed
}
...
% Helper: put theorem-like statements inside grey boxes (no outline).
\newenvironment{gdefn}{\begin{greybox}\begin{definition}}{\end{definition}\end{greybox}}
\newenvironment{gassm}{\begin{greybox}\begin{assumption}}{\end{assumption}\end{greybox}}
\newenvironment{gthm}{\begin{greybox}\begin{theorem}}{\end{theorem}\end{greybox}}
\newenvironment{gprop}{\begin{greybox}\begin{proposition}}{\end{proposition}\end{greybox}}
\newenvironment{grem}{\begin{greybox}\begin{remark}}{\end{remark}\end{greybox}}
...
\makepagestyle{mystuff}
% \makeheadrule{mystuff}{\textwidth}{\normalrulethickness}
\makeevenhead{mystuff}{\hffont\thepage}{}{\hffont}
\makeoddhead{mystuff}{\hffont}{}{\hffont\thepage}
\makeevenfoot{mystuff}{}{}{}
\makeoddfoot{mystuff}{}{}{}
\makepsmarks{mystuff}{
    \nouppercaseheads
...
\makechapterstyle{mychapterstyle}{
    ...
    \renewcommand*{\chapnumfont}{\format\fontsize{35}{35}\selectfont}
...
\hypersetup{
    ...
    filebordercolor=mydarkblue,           % color of file links
    linkbordercolor=mydarkblue,           % color of internal links (change box color with linkbordercolor)
    urlbordercolor=s13,        
...
\newmdenv[
  backgroundcolor=gray!10,
  linewidth=0pt,        % <-- no black outline
  skipabove=6pt,
  skipbelow=10pt,
  innerleftmargin=8pt,
